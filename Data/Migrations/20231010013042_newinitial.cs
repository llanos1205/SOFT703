        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Trolley_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SenderCountryId = table.Column<string>(type: "nvarchar(450)", nullable: false),
                    ReceiverCountryId = table.Column<string>(type: "nvarchar(450)", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Exchange", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Exchange_Agent_AgentId",
                        column: x => x.AgentId,
                        principalTable: "Agent",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Exchange_Country_ReceiverCountryId",
                        column: x => x.ReceiverCountryId,
                        principalTable: "Country",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Exchange_Country_SenderCountryId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AmountConverted = table.Column<double>(type: "float", nullable: false),
                    UserId = table.Column<string>(type: "nvarchar(450)", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Transaction_Exchange_ExchangeId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Exchange_AgentId",
                table: "Exchange",
                column: "AgentId");

            migrationBuilder.CreateIndex(
                name: "IX_Exchange_ReceiverCountryId",
                table: "Exchange",
                column: "ReceiverCountryId");

            migrationBuilder.CreateIndex(
                name: "IX_Exchange_SenderCountryId",
                table: "Exchange",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Transaction_ExchangeId",
                table: "Transaction",
                column: "ExchangeId");
